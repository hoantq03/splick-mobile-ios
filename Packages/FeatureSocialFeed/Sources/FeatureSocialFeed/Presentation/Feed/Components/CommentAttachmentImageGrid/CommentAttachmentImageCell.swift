...
struct CommentAttachmentImageCell: View, Equatable {
    let image: CommentAttachmentPreviewImage
    ...
    static func == (lhs: CommentAttachmentImageCell, rhs: CommentAttachmentImageCell) -> Bool {
        lhs.image == rhs.image
    ...
    var body: some View {
        ZStack(alignment: .topTrailing) {
            ZStack {
                ...
                CommentAttachmentUploadOverlay(
                    uploadStatus: image.uploadStatus,
                    onRetry: nil
                )

                if showsMoreOverlay, moreCount > 0 {
                    CommentAttachmentMoreImagesOverlay(hiddenCount: moreCount)
                }
