...
public enum AppConstants {
    ...
    public enum UserDefaults {
        ...
        public static let selectedColorTheme = "selectedColorTheme"
        ...
        public static let pushNotificationSound = "pushNotificationSound"
    ...
    public enum Media {
        public static let maxImageSizeBytes: Int = 10 * 1024 * 1024 // 10 MB (posts / comment attachments)
        ...
        public static let maxUploadLongSide: CGFloat = 2048
