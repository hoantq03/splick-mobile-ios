...
public struct AttachmentPreviewRoute: Identifiable {
    public let id = UUID()
...
public enum LocalImagePreviewSupport {
    public static func decodeImages(from attachments: [CommentSubmissionAttachment]) -> [UIImage] {
...
public struct LocalImageFullscreenPreview: View {
    let images: [UIImage]
    ...
    public init(images: [UIImage], initialIndex: Int, onDismiss: @escaping () -> Void) {
        self.images = images
...
public struct LocalImageThumbnailStrip: View {
    let images: [UIImage]
    ...
    public init(
        images: [UIImage],
        thumbnailWidth: CGFloat = 72,
        thumbnailHeight: CGFloat = 72,
...
public struct AttachmentDraftStrip: View {
    ...
    public init(
        ...
        thumbnailWidth: CGFloat = 72,
        thumbnailHeight: CGFloat = 72,
        onTapDraft: @escaping (Int) -> Void,
        onRemoveDraft: @escaping (Int) -> Void
    ) {
        self.drafts = drafts
        self.thumbnailWidth = thumbnailWidth
        self.thumbnailHeight = thumbnailHeight
        self.onTapDraft = onTapDraft
...
public struct PendingAttachmentStrip: View {
    ...
    public init(
        ...
        thumbnailWidth: CGFloat = 72,
        thumbnailHeight: CGFloat = 72,
        onTapAttachment: @escaping (Int) -> Void,
...
public struct RemoteGifFullscreenPreview: View {
    let url: URL
    let onDismiss: () -> Void
...
public struct RemoteImageFullscreenPreview: View {
    let urls: [URL]
    let initialIndex: Int
    let onDismiss: () -> Void
    ...
    public init(urls: [URL], initialIndex: Int, onDismiss: @escaping () -> Void) {
        self.urls = urls
        self.initialIndex = initialIndex
        self.onDismiss = onDismiss
        _selectedIndex = State(initialValue: initialIndex)
